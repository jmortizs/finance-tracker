...
export function PanelState({ title, message }: PanelStateProps) {
  return (
    <div className="flex h-full min-h-[160px] flex-col items-center justify-center border border-grid px-4 py-8 text-center">
...
export function ChartPanel({ title, status, error, isEmpty, children }: ChartPanelProps) {
  return (
    <section className="flex h-full min-h-0 flex-col bg-canvas">
      <div className="flex min-h-10 items-center justify-between border-b border-grid px-4">
