...
* High Visibility Accent: Use `#87E614` (High-contrast Chartreuse / Lime Green).
...
* Status Badges: Do not use background fills; render using a transparent container with a sharp 1px solid `#87E614` outline housing uppercase text.
* Action Buttons: Style with a solid `#FFFFFF` block fill and bold `#000000` text.
* Hover States: Button transformations must switch instantly without animation properties to a `#87E614` block fill or outline.
...
* Donut Geometry: Use a narrow inner radius gap and cycle through clean, high-contrast values (`#FFFFFF`, `#87E614`, `#888888`, `#A0A0A0`, and `#1C1C1C`).
